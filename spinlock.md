...
При переключении контекста потоков, планировщик ОС для каждого потока восстанавливает значения его регистров и регистр ```rsp``` переводит на адрес вершины стека нового потока.
