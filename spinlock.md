...
При переключении контекста на новый поток, планировщик ОС восстанавливает сохранённые значения его регистров, в частности регистр ```rsp``` переводит на адрес вершины стека этого потока и восстанавливает регистр ```rip``` на адрес прерванной инструкции.
