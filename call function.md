...
- для 14-ти элементов 0 байт к исходным 120 байтам,
- для 15-ти и 16-ти 8 байт (120 + 8 = 128),
- для 17-ти и 18-ти 24 байта (120 + 24 = 144),
- для 19-ти и 20-ти 40 байт (120 + 40 = 160),
- для 21-ти и 22-ти 56 байт (120 + 56 = 176).  
```asm
func1:
  pushq %rbp
  movq %rsp, %rbp
