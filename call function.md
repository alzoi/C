...
- для 14 элементов: 0 байт к исходным 120 байтам,
- для 15 и 16: 8 байт (120 + 8 = 128),
- для 17 и 18: 24 байта (120 + 24 = 144),
- для 19 и 20: 40 байт (120 + 40 = 160),
- для 21 и 22: 56 байт (120 + 56 = 176).  
```asm
func1:
  pushq %rbp
  movq %rsp, %rbp
