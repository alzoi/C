...
![image](https://user-images.githubusercontent.com/20499566/187384645-dfc97543-9abb-4d97-84af-4112a7c331ae.png)
...
Возвращаемое значение вызванная функция передаёт через регистр ```rax```.
