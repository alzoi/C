...
Седьмой и далее аргументы вызываемой функции передаются через стек вызывающей функции. Возвращаемое значение вызванная функция передаёт через регистр ```rax```.
