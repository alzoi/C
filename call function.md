...
```
В асемблерном коде мы видим, что указатель стека не двигается, отсутствует директива subq $8, %rsp (которая появится, если создать массив из 15 элементов по 8 байт): 
```asm
func1:
  pushq %rbp
  movq %rsp, %rbp
