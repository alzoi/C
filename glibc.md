...
```
Если удалить или переместить символьную ссылку /lib/x86_64-linux-gnu/libc.so.6 или файл библиотеки, то система Linux **перестанет работать**, так как любые команды обращаются к стандартной библиотеке lbc.  
